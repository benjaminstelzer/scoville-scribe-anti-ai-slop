...
directly with the same tokenizer: `v1.0.6` used 1,784 tokens and the qualified
Skill uses 1,430, a reduction of 354 tokens (-19.84%). This comparison is
separate from the reliability-matched benchmark control above.
